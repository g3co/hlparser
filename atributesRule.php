...
if($data[16]) {$atributes->set('material',$data[16]);} elseif (isset($atributesFromName->material)) {$atributes->set('material',$atributesFromName->material);}
if($data[17]) {$atributes->set('size',$data[17]);} elseif (isset($atributesFromName->size)) {$atributes->set('size',$atributesFromName->size);}
if($data[18]) {$atributes->set('length',$data[18]);} elseif (isset($atributesFromName->length)) {$atributes->set('length',$atributesFromName->length);}
if($data[19]) {$atributes->set('width',$data[19]);} elseif (isset($atributesFromName->width)) {$atributes->set('width',$atributesFromName->width);}
...
if($data[22]) {$atributes->set('battery',$data[22]);} elseif (isset($atributesFromName->battery)) {$atributes->set('battery',$atributesFromName->battery);}
if($data[23]) {$atributes->set('waterproof',($data[23]) ? "Да" : NULL);} 
                elseif (isset($atributesFromName->waterproof)) {$atributes->set('waterproof',$atributesFromName->waterproof);}
if($data[24]) {$atributes->set('contry',$data[24]);} elseif (isset($atributesFromName->contry)) {$atributes->set('contry',$atributesFromName->contry);}
if(isset($categoryArr[1]) && $categoryArr[1] == "С вибрацией") {$atributes->set('vibration',"Да");} elseif(isset($categoryArr[1]) && $categoryArr[1] == "Без вибрации") {$atributes->set('vibration',"Нет");} 

if($categoryArr[0] == "Вибраторы") {$atributes->set('vibration',"Да");} elseif($categoryArr[0] == "Фаллоимитаторы") {$atributes->set('vibration',"Нет");} 
